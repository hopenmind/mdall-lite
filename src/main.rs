...
struct MdApp {
    ...
    /// Stable ids (document order) of the current doc's display equations, for the
    /// edit-history log. Injected to disk on save; the editor buffer stays clean.
    doc_eq_ids: Vec<(String, String)>,
    modified: bool,
    show_metadata: bool,
    show_search: bool,
    search_query: String,
    ...
    /// Toggle for the equation edit-history side panel ("git for equations").
