...
pub const ACCENT:       Color32 = Color32::from_rgb(126, 99, 174);  // #7E63AE dusty violet (softened from the garish #A020C0)
pub const ACCENT_HOVER: Color32 = Color32::from_rgb(94, 68, 136);   // #5E4488
