...
const FR: &[(&str, &str)] = &[
    ...
    ("view.gallery", "\u{00C9}diteur d'\u{00E9}quations"),
    ("module.title", "Modules"),
...
const ES: &[(&str, &str)] = &[
    ...
    ("view.split", "Dividido"),
    ("view.editor", "Editor"),
    ("view.gallery", "Editor de ecuaciones"),
...
const IT: &[(&str, &str)] = &[
    ...
    ("view.split", "Diviso"),
    ("view.editor", "Editor"),
    ("view.gallery", "Editor di equazioni"),
    ("module.title", "Moduli"),
