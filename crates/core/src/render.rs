...
pub const GREEKS: &[(&str, &str)] = &[
    ...
    ("\\Pi", "Π"), ("\\Xi", "Ξ"), ("\\Upsilon", "Υ"),
    ("\\upsilon", "υ"), ("\\omicron", "ο"),
    ("\\vartheta", "ϑ"), ("\\varpi", "ϖ"), ("\\varrho", "ϱ"),
    ("\\varsigma", "ς"), ("\\varkappa", "ϰ"), ("\\digamma", "ϝ"),
];
...
pub const SYMBOLS: &[(&str, &str)] = &[
    ...
    ("\\bigl", ""), ("\\bigr", ""), ("\\Bigl", ""), ("\\Bigr", ""),
    ("\\biggl", ""), ("\\biggr", ""),
    // -- Coverage audit 2026-07-06: commands that otherwise leak as literal
    //    names through the drop-backslash fallback (arrows, big operators,
    //    logic, order/lattice relations, norms, physics). The caller applies
    //    these longest-command-first, so ordering here is irrelevant.
    ...
    ("\\hslash", "ℏ"), ("\\imath", "ı"), ("\\jmath", "ȷ"),
    ("\\Vert", "‖"), ("\\lVert", "‖"), ("\\rVert", "‖"), ("\\|", "‖"),
    ("\\vert", "|"), ("\\lvert", "|"), ("\\rvert", "|"),
    ("\\dots", "..."), ("\\dotsc", "..."), ("\\dotsb", "⋯"), ("\\dotsi", "⋯"),
    ("\\lozenge", "◊"), ("\\Diamond", "◇"), ("\\blacksquare", "■"), ("\\blacktriangle", "▲"),
    ("\\flat", "♭"), ("\\sharp", "♯"), ("\\natural", "♮"),
    ("\\colon", ":"), ("\\bmod", " mod "),
];
